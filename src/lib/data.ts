...
export const properties: Property[] = [
  ...
  },
  {
    ...
    squareFeet: 4500,
    rating: 4.9,
    description: 'Live the Italian dream in this beautifully restored 18th-century villa. Set amidst olive groves and vineyards, it offers a private pool, classic Italian gardens, and breathtaking views.',
    amenities: ['wifi', 'pool', 'kitchen', 'parking', 'fireplace'],
  ...
  },
  {
    ...
    squareFeet: 2400,
    rating: 4.6,
    description: 'A classic New England farmhouse on a working organic farm. Participate in farm activities, enjoy fresh produce, and relax by the pond. A truly authentic farm-to-table experience.',
    ...
    squareFeet: 800,
    rating: 5.0,
    description: 'A cliffside resort offering unparalleled views of the Pacific Ocean. Focus on wellness and relaxation with our award-winning spa, yoga classes, and gourmet organic restaurant.',
    amenities: ['wifi', 'pool', 'gym', 'spa', 'restaurant'],
